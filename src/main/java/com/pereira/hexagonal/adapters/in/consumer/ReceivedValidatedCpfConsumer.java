package com.pereira.hexagonal.adapters.in.consumer;

import com.pereira.hexagonal.adapters.in.consumer.mapper.CustomerMessageMapper;
...
public class ReceivedValidatedCpfConsumer {
    ...
    @KafkaListener(topics = "tp-cpf-validated", groupId = "pereria")
